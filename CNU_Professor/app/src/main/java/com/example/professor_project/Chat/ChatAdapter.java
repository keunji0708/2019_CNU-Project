...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    @Override
    public ChatAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, //어떤 레이아웃 쓸 지 정해
                                                       int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) { //뷰홀더에서 데이터 세팅
        ...
        if(chat.getNickname().equals(this.myNickName)) { //닉네임 비교!해서 같으면 오른쪽 정렬 내꺼니까
